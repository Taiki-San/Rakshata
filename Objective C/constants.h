...
#define CT_VIEW_READERMORE_WIDTH_PROJECT_NAME	25
#define CT_VIEW_READERMORE_WIDTH_SPACE_NEXT_PROJECTIMAGE 20
#define CT_VIEW_READERMORE_HEIGHT_PROJECT_IMAGE	150
#define CT_VIEW_READERMORE_HEIGHT_HEADER_TAB (CT_VIEW_READERMORE_WIDTH_PROJECT_NAME + 2 * CT_VIEW_READERMORE_WIDTH_SPACE_NEXT_PROJECTIMAGE + CT_VIEW_READERMORE_HEIGHT_PROJECT_IMAGE)
