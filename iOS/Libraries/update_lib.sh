...
do
	...
	then
		...
		SQLITE_FLAGS="-O3 -c -DHAVE_USLEEP=1 -DSQLITE_ENABLE_FTS3 -DSQLITE_ENABLE_FTS3_PARENTHESIS -DSQLITE_ENABLE_ICU -DU_DISABLE_RENAMING=1 -I/usr/local/opt/icu4c/include"
	...
	then
		...
		echo "Configuring the package"
		./configure --disable-debug --host=arm-apple-darwin --enable-optimize --enable-static --disable-shared --disable-ftp --disable-file --disable-ldap --disable-ldaps --disable-rtsp --disable-dict --disable-telnet --disable-tftp --disable-pop3 --disable-imap --disable-smtp --disable-gopher --disable-manual --disable-smb --enable-ipv6 --enable-threaded-resolver --disable-verbose --disable-sspi --disable-ntlm-wb --disable-cookies --disable-soname-bump --with-darwinssl --without-ca-bundle --without-libssh2 --without-librtmp --without-winidn --without-libidn --disable-libcurl-option > ../config_libcurl.log
