...
#define STATE_READER_TAB_SERIE_FOCUS		0x1
#define STATE_READER_TAB_CT_FOCUS			0x2
#define STATE_READER_TAB_MDL_FOCUS			0x4
#define STATE_READER_TAB_ALL_COLLAPSED		0x0
#define STATE_READER_TAB_DISTRACTION_FREE	0x8
